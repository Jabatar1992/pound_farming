...
if (!isset($_POST['flock_id'], $_POST['feed_id'], $_POST['quantity_kg'], $_POST['consumption_date'])) {
    respondBadRequest("Invalid request. flock_id, feed_id, quantity_kg and consumption_date are required.");
}
