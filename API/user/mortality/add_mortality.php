...
if (!isset($_POST['flock_id'], $_POST['count'], $_POST['cause'], $_POST['mortality_date'])) {
    respondBadRequest("Invalid request. flock_id, count, cause and mortality_date are required.");
}
