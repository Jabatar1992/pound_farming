...
if (!isset($_POST['flock_id'], $_POST['eggs_collected'], $_POST['collection_date'])) {
    respondBadRequest("Invalid request. flock_id, eggs_collected and collection_date are required.");
}
